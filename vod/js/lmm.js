...
const appConfig = {
  ...
  filterListUrl: '@{webSite}/vod/show/id/@{mainId}/page/@{page}/year/@{filterId1}.html',

  mainListUrl: '@{webSite}/vod/show/id/@{mainId}.html',
  ...
  playFromTag: {
    name: 'div',
    class: 'module-list module-player-list tab-list sort-list module-vod-list',
  },
